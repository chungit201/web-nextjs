...
const BoardWrapper = ({ containerHeight, useClone, isCombineEnabled, withScrollableColumns, setDrawerMode }) => {
				...
				<div className="scrumboard" ref={provided.innerRef} {...provided.droppableProps}>
					<div className="scrumboard-header">
						...
						<div className="text-right">
							...
							<div>
								<Button type="primary" ghost className="mr-2" size="small" onClick={() => onAddBoardModal()}>New Board</Button>
								<Button type="primary" size="small" onClick={() => setDrawerMode(true)}>Assign Member</Button>
							</div>
						</div>
					</div>
