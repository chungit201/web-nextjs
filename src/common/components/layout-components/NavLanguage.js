...
import lang from "common/assets/data/language.data.json";
import { connect } from "react-redux";
import { onLocaleChange } from 'common/redux/actions/Theme'
...
const SelectedLanguage = ({ locale }) => {
	...
	return (
		<div className="d-flex align-items-center">
			<Image style={{maxWidth: '20px'}} src={`/img/flags/${icon}.png`} alt={langName}/>
				...
				lang.map((elm, i) => {return (
					...
					>
						<span className="d-flex justify-content-between align-items-center">
							<div>
								<Image style={{maxWidth: '20px'}} src={`/img/flags/${elm.icon}.png`} alt={elm.langName}/>
